	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<div class="form-group">
		    	...
		    	<input type="text" class="form-control" name="name" placeholder="Enter Fruit Name" value="<?php echo e(old('name')); ?>">
		  	...
		  	<div class="form-group">
		    	...
		    	<textarea class="form-control" name="description" rows="3" placeholder="Enter Fruit Description"> <?php echo e(old('description')); ?> </textarea>
		  	...
		  	<div class="form-group">
		    	...
		    	<input type="text" class="form-control" name="price" placeholder="Enter Fruit Price" value="<?php echo e(old('price')); ?>" >
