			  	...
			  	<tbody style="text-align: center;">
						...
						<?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<tr>
						      	...
						      	<td style="line-height: 100px;"> <?php echo e($person->address); ?> </td>

						      	<td style="line-height: 100px;"> <?php echo e($person->mobile); ?> </td>						      	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\my\resources\views/myorders.blade.php ENDPATH**/ ?>